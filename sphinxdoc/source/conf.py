...
# -*- coding: utf-8 -*-
#
# ErrUt documentation build configuration file, created by
    ...
    if os.path.exists(cmakePath):
        ...
        for l in open(cmakePath):
            ...
            if l.startswith(pref):
                ...
                major, minor, debug = versionPart.split(".")
...
latex_documents = [
    (master_doc, 'errutdoc.tex', 'ErrUt Documentation',
...
man_pages = [
    (master_doc, 'errutdoc', 'ErrUt Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'errutdoc', 'ErrUt Documentation',
     author, 'errutdoc', 'Error utilities',
     'Miscellaneous'),
]
